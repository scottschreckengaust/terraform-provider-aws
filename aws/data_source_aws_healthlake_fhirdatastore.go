...
func dataSourceAwsHealthLakeFHIRDatastore() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceAwsHealthLakeFHIRDatastoreRead,

		// FYI: Schema matched from resource...
...
func dataSourceAwsHealthLakeFHIRDatastoreRead(d *schema.ResourceData, meta interface{}) error {
